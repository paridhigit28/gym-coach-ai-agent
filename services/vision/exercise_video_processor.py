    ...
    def recv(self, frame):
        ...
        if result.pose_landmarks:
            ...
            if detector:
                ...
                # Guided mode for exercises that do not yet have a dedicated
                # detector. The live camera, skeleton and AI coach still work.
                self.set_latest_metrics({"pose_detected": True, "tracking_mode": "guided"})
        else:
